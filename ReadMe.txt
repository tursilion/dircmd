...
-if you need to use quotes (ie: around filenames with spaces), pass \"
-'$f' is now universally replaced, instead of only at the beginning of a word
-pass -[1-31] at the start for number of simultaneous processes to spawn (the upper limit depends on your system)
